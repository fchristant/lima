...
export default function HueLightTemperaturePicker(props: { light: string, currentTemperature: number }) {
   ...
   return (
      <div>
         <input type="range" className="hue-light-temperature-picker" min="153" max="500" value={pickTemperature} onChange={handleChange}  />
      </div>
     )
}
